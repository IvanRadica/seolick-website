...
// Client names are withheld on purpose — Ivan adds specific names later via the
// `name` slot (null = anonymized). Organic figures are Ahrefs estimates.
...
export const resultsContent = {
  hr: {
    ...
    stats: [
      { number: '2.187', label: 'organskih posjeta / mj\niz blizu nule' },
      { number: '+315<em>%</em>', label: 'rast organskog\nprometa' },
      { number: '12–16<em>k</em>', label: 'organskih posjeta / mj\nodržano' },
    ],
    cases: [
      {
        name: null,
        industry: 'Yacht charter · HR',
        challenge: 'Nova domena, gotovo bez organske vidljivosti.',
        solution: 'Strukturni i programatski SEO, arhitektura, audit.',
        result: '0 → 2.187 / mj',
        resultSub: '258 kw u Google top 3 · DR 0,6 → 3,4 · ~10 mj',
        note: '',
      },
      {
        name: null,
        industry: 'Fashion e-commerce · RS',
      ...
      {
        name: null,
        industry: 'Najam plovila · HR',
        challenge: 'Sezonski vrhunci ovisni o plaćenim oglasima.',
        solution: 'Lokalni SEO i OTA profili.',
        result: '201 → 1.613 / mj',
        resultSub: 'vrhunac sezone, bez ulaganja u oglase',
        note: '',
      },
      {
        name: null,
        industry: 'Poliklinika · HR',
      ...
      {
        name: null,
        industry: 'Hitni zračni prijevoz · global',
        challenge: 'Rast računa i dugoročno partnerstvo.',
        solution: 'Google Ads, web i retainer.',
        result: '€500 → €2.000 / mj',
        resultSub: '4× rast suradnje kroz ~2,5 godine',
        note: 'Partnerstvo i rast računa — nije priča o organskom prometu.',
      },
    ],
  ...
  en: {
    ...
    stats: [
      { number: '2,187', label: 'organic visits / mo\nfrom near zero' },
      { number: '+315<em>%</em>', label: 'organic traffic\ngrowth' },
      { number: '12–16<em>k</em>', label: 'organic visits / mo\nsustained' },
    ],
    cases: [
      {
        name: null,
        ...
        result: '0 → 2,187 / mo',
        resultSub: '258 kw in Google top 3 · DR 0.6 → 3.4 · ~10 mo',
        note: '',
      },
      {
        name: null,
      ...
      {
        name: null,
        industry: 'Boat rental · HR',
        challenge: 'Seasonal peaks dependent on paid ads.',
        solution: 'Local SEO and OTA profiles.',
        result: '201 → 1,613 / mo',
        resultSub: 'peak season, zero ad spend on the organic side',
        note: '',
      },
      {
        name: null,
        industry: 'Polyclinic · HR',
      ...
      {
        name: null,
        industry: 'Air ambulance · global',
        challenge: 'Grow the account and a long-term partnership.',
        solution: 'Google Ads, web and a retainer.',
        result: '€500 → €2,000 / mo',
        resultSub: '4× account growth over ~2.5 years',
        note: 'A partnership and account-growth story — not organic traffic.',
      },
    ],
