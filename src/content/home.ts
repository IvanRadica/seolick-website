      ...
      pillars: [
        {
          letter: 'L',
          name: 'Linkovi',
          lead: 'U Googleovom svijetu, linkovi su povjerenje.',
          desc: 'Kad druge, ozbiljne stranice govore o vama, Google vas shvaća ozbiljno i daje vam bolje pozicije.',
          includes: ['Spominjanja u medijima', 'Digitalni PR', 'Provjera postojećih linkova'],
        },
        {
          letter: 'I',
          name: 'Infrastruktura',
          lead: 'Prije nego rangirate, Google vas mora razumjeti.',
          desc: 'Sređujemo ono ispod haube: brzinu, strukturu i tehničke detalje zbog kojih vas Google razumije i nagrađuje.',
          includes: ['Brzina stranice', 'Jasna struktura weba', 'Tehničko zdravlje stranice'],
        },
        {
          letter: 'C',
          name: 'Content',
          lead: 'Prave riječi. Prava stranica. Pravi trenutak.',
          desc: 'Sadržaj koji rangira i odgovara točno na ono što vaš kupac traži, zbog čega dovodi do upita, a ne samo čitanja.',
          includes: ['Blog strategija', 'Conversion Rate Optimizacija', 'Sadržaj koji AI citira'],
        },
        {
          letter: 'K',
          name: 'Ključne riječi',
          lead: 'Znajte što vaši kupci traže, bolje nego što oni znaju.',
          desc: 'Otkrivamo što vaši kupci upisuju u tražilicu i gradimo plan oko toga. Temelj svega ostalog.',
          includes: ['Što kupci stvarno traže', 'Koje pretrage donose upite', 'Što radi konkurencija'],
        },
      ],
      ...
      pillars: [
        {
          letter: 'L',
          name: 'Links',
          lead: 'In Google’s world, links are trust.',
          desc: 'When serious sites talk about you, Google takes you seriously — and gives you better positions.',
          includes: ['Media mentions', 'Digital PR', 'Review of existing links'],
        },
        {
          letter: 'I',
          name: 'Infrastructure',
          lead: 'Before you rank, Google needs to understand you.',
          desc: 'We fix what’s under the hood: the speed, structure and technical details that make Google understand and reward you.',
          includes: ['Site speed', 'Clear site structure', 'Technical site health'],
        },
        {
          letter: 'C',
          name: 'Content',
          lead: 'The right words. The right page. The right moment.',
          desc: 'Content that ranks and answers exactly what your customer is looking for — bringing inquiries, not just reads.',
          includes: ['Blog strategy', 'Conversion rate optimization', 'Content AI cites'],
        },
        {
          letter: 'K',
          name: 'Keywords',
          lead: 'Know what your customers search — better than they do.',
          desc: 'We uncover what your customers type into search and build the plan around it. The foundation for everything else.',
          includes: ['What customers really search', 'Which searches bring inquiries', 'What competitors are doing'],
        },
      ],
