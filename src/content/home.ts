      ...
      pillars: [
        {
          ...
          desc: 'U Googleovom svijetu, linkovi su povjerenje. Kad druge, ozbiljne stranice govore o vama, Google vas shvaća ozbiljno i daje vam bolje pozicije.',
          includes: ['Spominjanja u medijima', 'Linkovi s relevantnih stranica', 'Provjera postojećih linkova'],
        },
        {
          letter: 'I',
          name: 'Infrastruktura',
      ...
      pillars: [
        {
          ...
          desc: 'In Google’s world, links are trust. When serious sites talk about you, Google takes you seriously — and gives you better positions.',
          includes: ['Media mentions', 'Links from relevant sites', 'Review of existing links'],
        },
        {
          letter: 'I',
          name: 'Infrastructure',
